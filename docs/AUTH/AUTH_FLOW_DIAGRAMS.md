...
These diagrams show the complete flow of authentication in the Recurly app from start to finish. Use them for understanding the architecture and explaining flows to team members.
